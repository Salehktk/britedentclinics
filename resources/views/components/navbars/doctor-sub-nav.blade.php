<a class="nav-link {{ (request()->route()->getName() == 'dashboard' || request()->route()->getName() == 'doctor_dashboard') ? 'active' : '' }}" aria-current="page" href="{{ route('doctor_dashboard') }}"> <i class="fad fa-dashboard"></i> Dashboard</a>
