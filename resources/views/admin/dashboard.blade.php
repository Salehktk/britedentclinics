            ...
            <div class="row mb-4">
                <div class="col-md-12 col-12">
                    <div class="card border-0 shadow-sm p-2">
                        <strong class="card-title">Monthly Registered Users</strong>
    ...
    <script type="text/javascript">
        ...
        var chart = new Chart(ctx, {
            ...
            data: {
                ...
                datasets: [{
                    label: '',
                    backgroundColor: ["#6c63ff", "#6c63ff", "#6c63ff", "#6c63ff", "#6c63ff", "#6c63ff",
                        "#6c63ff", "#6c63ff", "#6c63ff", "#6c63ff", "#6c63ff", "#6c63ff", 'white'
                    ],
                    data: [
                        {{ $month['jan'] }},
                        {{ $month['feb'] }},
