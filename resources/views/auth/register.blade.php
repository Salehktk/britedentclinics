                        ...
                        <div class="p-4">
                            <form method="POST" action="{{ route('register') }}" class="row g-3 needs-validation" novalidate>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <x-input-field type="phone" name="phone" id="phone"
                                        place="Enter Your Phone Number" val="" required="true" />
                                </div>

                                <div class="col-md-12">
                                    <x-input-label name="Password" for="password" required='true' />
                                    <x-input-field type="password" name="password" id="password"
                                        place="Enter at least 8 characters password" val="" required="true" />
                                </div>
                                <x-role-list />
