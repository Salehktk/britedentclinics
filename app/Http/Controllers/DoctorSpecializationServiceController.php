...
use App\Models\DoctorSpecializationService;
use Illuminate\Http\Request;

class DoctorSpecializationServiceController extends Controller
{
    use BaseQuery;
     ...
     */
    public function __construct(Request $request, DoctorSpecializationService $modal)
    {
    ...
    public function specialization_service_destroy($id)
    {
